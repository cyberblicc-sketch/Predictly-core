      ...
      <CardContent className="space-y-6 pt-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button
            ...
            onClick={() => {
              toast.info('Google OAuth', { description: 'Demo: Google sign-in would redirect to OAuth provider.' })
            }}
          >
          ...
          <Button
            ...
            className="h-11 bg-bg-subtle border-border hover:border-border-strong hover:bg-bg-elevated gap-2"
            onClick={() => {
              toast.info('Apple OAuth', { description: 'Demo: Apple sign-in would redirect to OAuth provider.' })
            }}
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 text-fg-muted cursor-pointer">
              <input type="checkbox" className="rounded border-border accent-brand" />
              Remember me
            </label>
            <Link
              href="#"
              ...
              onClick={(e) => {
                ...
                toast.info('Password Reset', {
                  description: 'Demo: A password reset email would be sent.',
                })
              }}
            >
              Forgot password?
